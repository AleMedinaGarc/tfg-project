...
export default function HelpScreen() {
    return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Text style={fonts.blackFont}>
                Esta aplicación es un proyecto de Trabajo de Fin de Grado perteneciente a Alejandro Medina García, finalizando sus estudios de Ingenieria Informática en la Universidad de La Laguna.</Text>
            <Image
